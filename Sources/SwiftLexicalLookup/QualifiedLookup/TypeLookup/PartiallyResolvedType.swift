...
@_spi(_QualifiedLoookup) public enum PartiallyResolvedType {
  ...
  case function(argumentCount: Int)
  case tuple(labels: [Identifier?])
  // case typeId(Result<PartiallyResolvedTypeIdentifier, LocalizedTypeResolutionFailure>)
  case metatype(of: TypeSyntax)
  case id(PartiallyResolvedTypeIdentifier.Component)
  case member(base: TypeSyntax, memberComponent: PartiallyResolvedTypeIdentifier.Component)
...
extension TypeSyntaxProtocol {
  ...
  public func partiallyResolve() -> PartiallyResolvedType {
